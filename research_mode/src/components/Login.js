          ...
          return (
               <Container>
                  ...
                  <Card>
                      ...
                      <Button block success style={styles.LoginCustomer} onPress={ () => navigate('LoginForm') }><Text style={styles.textStyle}> Customer </Text></Button>
                      <Button block warning style={styles.LoginMontir} onPress={ () => navigate('LoginFormMechanic') }><Text style={styles.textStyle}> Montir </Text></Button>
                  </Content>
                </Container>
          )
     }
